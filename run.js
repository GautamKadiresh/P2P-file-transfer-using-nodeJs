...
datestr=datetime.toISOString().slice(0,10)+" "+datetime.getHours()+":"+datetime.getMinutes()+":"+datetime.getSeconds();
    console.log(datestr);
...
app.post('/upload/*',(req, res) => {
	...
	{	
		...
		{
		if(err)
			{console.log(err);res.send("error occured");}
		else
...
app.get('/:file(*)',(req, res) => {
	...
	{	if (file === "") 
		...
		if (file === "index.html")
			{res.render(fileLocation,{ngrokurl:ngrokurl});}
